...
<div id="factor3" class="factor">
	<h3>Factor 3:  Amount and Substantiality of Portion Used</h3>
		...
		<p class="favor">Weighs in Favor of Fair Use</p>
			...
			<li><input type="checkbox" value="amount taken is narrowly tailored to educational purpose such as criticism, comment, research, or subject being taught" id="f53" name="fac3favor[]" /><label for="f53">Amount taken is narrowly tailored to educational purpose such as criticism, comment, research, or subject being taught</label></li>
			</ul>
		</div>
